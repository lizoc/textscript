...
//     Last Updated: 24/1/2019 5:17:25 PM
//
...
namespace Lizoc.TextScript.Runtime
{
    public abstract partial class DynamicCustomFunction
    {
		...
		static DynamicCustomFunction()
        {
			...
			BuiltinFunctions.Add(typeof(TSF.StringFunctions).GetTypeInfo().GetDeclaredMethod(nameof(TSF.StringFunctions.Format)), method => new Function_string_object_string(method));
        ...
        /// <summary>
        /// Optimized custom function for: string (object, string)
        /// </summary>
        private class Function_string_object_string : DynamicCustomFunction
        {
            private delegate string InternalDelegate(object arg0, string arg1);

            private readonly InternalDelegate _delegate;

            public Function_string_object_string(MethodInfo method) 
            	: base(method)
            {
                _delegate = (InternalDelegate)method.CreateDelegate(typeof(InternalDelegate));
            }
