// -----------------------------------------------------------------------
// <copyright file="HtmlHelper.cs" repo="TextScript">
...
{
    /// <summary>
    /// Reimplementation of WebUtility (https://github.com/dotnet/corefx/blob/v2.2.0/src/System.Runtime.Extensions/src/System/Net/WebUtility.cs) with
    /// some modifications.
    /// </summary>
    internal class HtmlHelper
    {
        ...
        #region HtmlEncode/HtmlDecode implements
                ...
                if (ch == '&')
                {
                    ...
                    if (index > 0 && value[index] == ';')
                    {
                        ...
                        if (entityLength > 1 && value[entityOffset] == '#')
                        {
                            ...
                            {
                                parsedSuccessfully = uint.TryParse(
                                    value.Substring(entityOffset + 2, entityLength - 2),
                            ...
                            {
                                parsedSuccessfully = uint.TryParse(
                                    value.Substring(entityOffset + 1, entityLength - 1),
        ...
        #endregion // HtmlEncode/HtmlDecode implements

        #region UrlEncode/UrlDecode implement
        ...
        #endregion // UrlEncode/UrlDecode implement
        ...
        private static class HtmlEntities
        {
            ...
            static HtmlEntities()
            {
                ...
                Debug.Assert(
                    s_lookupTable.Count == Count, 
                    string.Format("There should be {0} HTML entities, but {1} has {2} of them.", Count, nameof(s_lookupTable), s_lookupTable.Count));
            }
#endif
            ...
            private static readonly Dictionary<string, char> s_lookupTable = new Dictionary<string, char>(Count, StringComparer.Ordinal)
            {
                ["quot"] = '\x0022',
                ["amp"] = '\x0026',
                ["apos"] = '\x0027',
