// -----------------------------------------------------------------------
// <copyright file="LiquidBuiltinsFunctions.cs" repo="TextScript">
...
namespace Lizoc.TextScript.Functions
{
    ...
    public class LiquidBuiltinsFunctions : ScriptObject
    {
        ...
        {
            // We copy the default template script objects
        ...
        public static bool TryImportLiquid(string liquidBuiltin, out string target, out string member)
        {
            if (liquidBuiltin == null)
                throw new ArgumentNullException(nameof(liquidBuiltin));
        ...
        private class DefaultBuiltins : ScriptObject
        {
            public DefaultBuiltins() : base(50, false)
            {
                ...
                ScriptObject date = (ScriptObject)BuiltinFunctions.Default[DateTimeFunctions.DateVariable.Name];
                ScriptObject html = (ScriptObject)BuiltinFunctions.Default["html"];
                ScriptObject objs = (ScriptObject)BuiltinFunctions.Default["object"];
